...
In short there is:
- [deb package](https://github.com/krylosov-aa/pg-status/releases/download/1.4.2/pg-status_1.4.2_amd64.deb)
- [published container to Docker Hub](https://hub.docker.com/r/krylosovaa/pg-status)
- various [docker containers](docker)
- [static binary](https://github.com/krylosov-aa/pg-status/releases/download/1.4.2/pg-status_1.4.2_linux_amd64_static.tar.gz)
- [shared binary](https://github.com/krylosov-aa/pg-status/releases/download/1.4.2/pg-status_1.4.2_linux_amd64_shared.tar.gz)
