...
[Latest deb package](https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_amd64.deb)

```shell
wget https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_amd64.deb && \
sudo apt install ./pg-status_1.5.2_amd64.deb
```
...
[Latest static binary](https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_linux_amd64_static.tar.gz)

```shell
wget -qO- https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_linux_amd64_static.tar.gz | tar -xzv && \
chmod +x pg-status
```
...
[Latest shared binary](https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_linux_amd64_shared.tar.gz)

```shell
sudo apt-get install -y libpq5 libmicrohttpd12 libcjson1 && \
wget -qO- https://github.com/krylosov-aa/pg-status/releases/download/1.5.2/pg-status_1.5.2_linux_amd64_shared.tar.gz | tar -xzv && \
chmod +x pg-status
```
