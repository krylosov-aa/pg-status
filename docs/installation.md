...
[Latest deb package](https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_amd64.deb)

```shell
wget https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_amd64.deb && \
sudo apt install ./pg-status_2.2.0_amd64.deb
```
...
[Latest static binary](https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_linux_amd64_static.tar.gz)

```shell
wget -qO- https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_linux_amd64_static.tar.gz | tar -xzv && \
chmod +x pg-status
```
...
[Latest shared binary](https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_linux_amd64_shared.tar.gz)

```shell
sudo apt-get install -y libpq5 libevent-2.1-7t64 libcjson1 && \
wget -qO- https://github.com/krylosov-aa/pg-status/releases/download/2.2.0/pg-status_2.2.0_linux_amd64_shared.tar.gz | tar -xzv && \
chmod +x pg-status
```
